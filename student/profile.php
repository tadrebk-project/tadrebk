                    ...
                    <div class="card-body">
                        ...
                        <form action="backend/updateProfile.php" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" name="phone" maxlength="10" placeholder="05XXXXXXXX" value="<?php if ($phone != 0) {
                                                                                                    echo $phone;
                                                                                                } ?>" class="form-control" id="InputPhone" pattern="[0][5][0-9].{10}" disabled required>
                            </div>
                            <div class="mb-3">
