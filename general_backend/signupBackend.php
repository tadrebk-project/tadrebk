...
if (isset($_POST['reg_company'])) {
  ...
  $user_check_query = "SELECT * FROM tadreabkuser WHERE username='$username' LIMIT 1";
  ...
  if ($error == "") {
  	...
  	$query = "INSERT INTO tadreabkuser (username, password, type) VALUES('$username','$hash_password','representative');";
